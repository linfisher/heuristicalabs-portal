  ...
  return (
    <div style={{ background: "#0A0A0A", color: "#FAF7F0", fontFamily: "sans-serif", display: "flex", alignItems: "center", justifyContent: "center", minHeight: "calc(100vh - 4rem)" }}>
      <div style={{ textAlign: "center", maxWidth: 400, padding: "0 24px" }}>
        <h1 style={{ color: "#E8147F", fontSize: "1.75rem", marginBottom: "1rem" }}>Failed to load document</h1>
        <p style={{ color: "#9ca3af", marginBottom: "2rem" }}>We couldn&apos;t load this document. Please try again.</p>
        <button
          onClick={reset}
