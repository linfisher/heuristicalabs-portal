...
- **Invited users**: pending Clerk invitations are listed at the top of the users list with an "Awaiting sign-in" tag, their projects, and **Resend Invite** (`/portal/admin/invite/resend` revokes and recreates the invitation with the same grants, then resends the branded email).
